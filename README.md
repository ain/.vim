...
See [/plugged](https://github.com/ain/.vim/blob/main/.vimrc#L48-L76).
...
| `dG`                        | Delete till EOF                                                                                     |
| `:w !pbcopy`                | Yank entire buffer to pasteboard                                                                    |
| `"ay`                       | Yank to _a_ register                                                                                |
| `"ap`                       | Put from _a_ register                                                                               |
| `"*y`                       | Yank to clipboard                                                                                   |
| `F8`                        | Launch tagbar                                                                                       |
| `za`                        | Fold block                                                                                          |
...
| `:CocUninstall <extension>`  | Uninstall coc extension, e.g. discontinued one, e.g. RSL                                            |
| __vim-plug__                 |                                                                                                     |
